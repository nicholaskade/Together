        ...
        .then(response => {
            if (response.ok) {
                response.json().then(updatedPost => {
                    const filteredPosts = posts.filter(post => post.id !== updatedPost.id)
                    setPosts(
                        ...filteredPosts,
                        [updatedPost, filteredPosts]
                    )
                })
            } else {
                response.json().then(errors => setErrors(errors))
                        ...
                        <div className="post-container">
                            ...
                            <div className="post-header-container">
                                ...
                                <div className="post-footer">
                                    <CommentButton onClick={() => handleCommentClick(post.id)} className="post-footer-button"/>
