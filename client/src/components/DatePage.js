...
function DatePage() {
  ...
  function handleDelete() {
    ...
    fetch(`/outings/${targetPost}`, deleteRequest).then((res) => {
      if (res.ok) {
  ...
  return (
    <>
      ...
      <div
        onClick={() => navigate("/relationship-board")}
        id="go-back-from-dates"
      >
